# 🏛️ Site Web - Association des Jeunes El Kendi
...
4. Importez la base de données MySQL requise pour le projet.
5. **Configuration de la base de données :** Si nécessaire, ajustez les identifiants de connexion (hôte, nom de la base, utilisateur, mot de passe) directement dans le fichier `db.php`.
6. Ouvrez votre navigateur et accédez à l'adresse : `http://localhost/nom-du-dossier/index.php`
